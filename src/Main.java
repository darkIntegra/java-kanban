public class Main {
    ...
    //тестирование
        ...
        Subtask subtask1 = new Subtask("Subtask #1-1", "Subtask1-1 description", epic1.getId());
        Subtask subtask2 = new Subtask("Subtask #1-2", "Subtask1-2 description", epic1.getId());
        ...
        Subtask subtask3 = new Subtask("Subtask #2-1", "Subtask2-1 description", epic2.getId());
        ...
        Task upTask1 = new Task(task1.getId(), "Up Task #1", "Up Task1 description", Status.IN_PROGRESS);
        manager.updateTask(upTask1);

        Subtask upSubTask1 = new Subtask(subtask1.getId(), "Up Subtask #1-1", "UP Subtask1-1 description",
        ...
        Task upTask2 = new Task(task2.getId(), "Up Task #2", "Up Task2 description", Status.DONE);
        manager.updateTask(upTask2);

        Subtask upSubTask2 = new Subtask(subtask1.getId(), "Up2 Subtask #1-1", "UP2 Subtask1-1 description",
                Status.DONE, epic1.getId());
        manager.updateSubtask(upSubTask2);

        Subtask upSubTask3 = new Subtask(subtask2.getId(), "Up Subtask #2-1", "UP Subtask2-1 description",
                Status.DONE, epic1.getId());
        ...
        Subtask subtask4 = new Subtask("Subtask #1-3", "Subtask1-3 description", epic1.getId());
